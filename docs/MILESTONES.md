...
| **E2B** | Program graph and name resolution *(inserted by architect ruling, 2026-08-06)* | **implemented, gate partly met** — module graph, three namespaces, six resolution diagnostics running in `pw check`. Open: resolving *uses*, and handing `DefId` to the semantic analyses |
