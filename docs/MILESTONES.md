...
| **E5** | Privacy-flow, cache-safety, and placement checker | **3 of 5 gate items pass** — set-of-restrictions label algebra with exhaustively verified lattice laws, a placement solver over build/browser/edge/origin, and four corpus programs now compile errors. Open: the ≥50 compile-fail count and the store page |
