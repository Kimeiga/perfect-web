...
| **E7-R** | Own renderer: resumption and DOM preservation | not started — **Marko is the accepted oracle**. E7V's decision now governs the real handler path in three browser engines; what is missing is a renderer, not a decision |
