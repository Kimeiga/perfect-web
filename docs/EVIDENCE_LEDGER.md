...
| P0 | "33 of 44 rejected corpus programs are compile errors in real `.pw` source, and **each fails for the invariant it declares** — not merely for being red. All 24 accepted programs check clean." | E2, E2B, E2C, E2D | `docs/evidence/E2D/corpus-enforcement.txt` (`just evidence-corpus`); `docs/evidence/P0/readiness.txt` | rust 1.97.1 | **measured** | "the corpus is enforced" — the P0 gate is 40/44 and needs at least three more milestones (E5, E9, and one of E9C/E7/E6) |
